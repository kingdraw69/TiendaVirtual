...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageList.add(new SlideModel("https://bit.ly/2YoJ77H", "La población animal disminuyó un 58 por ciento en 42 años.", ScaleTypes.FIT));
        imageList.add(new SlideModel("https://bit.ly/2BteuF2", "Los elefantes y los tigres pueden extinguirse.",ScaleTypes.FIT));
        imageList.add(new SlideModel("https://bit.ly/3fLJf72", "Y la gente hace eso.",ScaleTypes.FIT));
